...
<spoiler>💡 <b>ТВОИ ПЕРВЫЕ ШАГИ К ВЕЛИЧИЮ (для максимального эффекта!):</b> 💡
...
2️⃣Затем примени команду /bonus, чтобы получить множитель к следующему обновлению OneUI <spoiler>(Но, это не точно)</spoiler>.
3️⃣И только потом активируй свой OneUI с помощью команды /oneui</spoiler>
